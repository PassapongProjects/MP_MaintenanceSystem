...
<script src="../js/pm_plan_creation.js"></script>
</head>
<body>
...
<div id=pg-container>
    <a href='../welcome.php' id='backLink'>หน้าหลัก</a>
    <a href='pm_plan_view_edit.php' id='view-edit-page-but'>ข้อมูล/แก้ไขรายระเอียดแผน PM</a>
    <div id='header-label-cont'><label id="topic-label"><h3><u>สร้างแผน PM</u></h3></label></div>
    <div class = "group-container" id="header-container">
    
    <label for="plan-id" id="pm-id-label">รหัสแผน PM: </label>
    <input type="hidden" id="plan-id" value="">
    <button type="button" id="Plan-Save-btn">บันทึกรายการ</button>
    <br>
<!-- Plan Name --> 
...
<!-- Plan Interval -->
    ...
    <input type="number" min=0 max=366 id ="plan_interval-textbox" placeholder="ช่วงเวลา">
